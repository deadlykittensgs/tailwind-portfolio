...
>
    ...
    >
        <h2 class="font-semibold text-4xl sm:text-5xl md:text-6xl">
            Hi! I'm <span class="poppins text-violet-400">Ryan</span> McMahon
            <br />Full Stack
        ...
        <a
            class="blueShadow mx-auto lg:mr-auto lg:ml-0 text-base sm:text-lg md:text-xl poppins relative overflow-hidden px-6 py-3 group rounded-full bg-white text-slate-950" href="https://github.com/deadlykittensgs" target="_blank"
        >
            <div
    ...
    <div class="relative shadow-2xl grid place-items-center">
        <img src={"src/publicish/ryan m-fotor-bg-remover-20240511153120.png"} alt="Profile Image" class="object-cover z-[2] max-h-[70vh]"/>
    </div>
