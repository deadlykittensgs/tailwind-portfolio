...
>
    ...
    <div class="flex flex-col gap-4 items-center justify-center">
        ...
        <p><b class="pr-2">Email</b> Ryan270win@gmail.com</p>
        <p>
            <b class="pr-2">GitHub</b>
            <a href="https://github.com/deadlykittensgs" target="_blank" class="text-violet-400"
                >Ryan_Mcmahon<sup class=""
        ...
        <p>
            ...
            <a href="https://www.linkedin.com/in/ryan-mcmahon-89785016b/" target="_blank" class="text-violet-400"
                >Ryan_Mcmahon<sup class=""
                    ><span class="text-xs scale-75 pl-0.5"
                        ><i
                            class="fa-solid fa-arrow-up-right-from-square text-xs scale-[75%]"
